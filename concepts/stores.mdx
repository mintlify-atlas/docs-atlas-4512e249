---
title: "Storage Backends in ThrottleKit"
sidebarTitle: "Stores"
...
const store = new MemoryStore({
  clock?: Clock,            // injectable time source (defaults to systemClock)
  maxKeys?: number,         // cap key cardinality to bound memory
  sweepIntervalMs?: number, // background expiry sweep interval (0 to disable)
});
```
