---
title: "twoTier() — Distributed Limiter with L1/L2"
...
### `eoqOptimum(demand, orderCost, strandPenalty)`

```ts
function eoqOptimum(demand: number, orderCost: number, strandPenalty: number): number
```
