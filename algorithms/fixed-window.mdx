...
<Tip>
  Fixed window is the cheapest strategy. If boundary bursts matter, reach for [sliding window](/algorithms/sliding-window) (bounded memory, near-exact) or [GCRA](/algorithms/gcra) (smooth pacing). If the limit is low and you need exact accuracy, use [sliding window log](/algorithms/sliding-window#sliding-window-log-exact).
</Tip>
